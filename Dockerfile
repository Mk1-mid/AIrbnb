...
RUN dotnet restore src/RentalPlatform.Web/RentalPlatform.Web.csproj

COPY . .
RUN dotnet publish src/RentalPlatform.Web/RentalPlatform.Web.csproj -c Release -o /app/publish --no-restore
